...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!-- Logo text --><span class="text-white">
                            ...
                            <!-- Light Logo text --> {{ config('app.name') }}
                        </span>
                    </a>
                </div>
                <!-- ============================================================== -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                                ...
                                <img src="{{ asset('assets/images/users/1.jpg') }}" alt="user"
                                    class="profile-pic m-r-10" />Claude</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li style="border-bottom:1px solid lightcyan;">
                            <a class="waves-effect waves-dark" href="#" aria-expanded="false">

                            <span class="hide-menu d-block text-success"> <i class="mdi mdi-account-circle text-success"></i>Connecté</span>
                            <small class="small text-muted">Iv : 0012-45</small>
                        </a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <i class="mdi mdi-format-list-bulleted-type"></i><span class="hide-menu">Produits</span></a>
                        </li>
                        <li>
                            <a class="waves-effect waves-dark" href="index.html" aria-expanded="false">
                                <i class="mdi mdi-format-list-bulleted"></i>
                                <span class="hide-menu">Catégories</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="index.html" aria-expanded="false"><i
                                    class="mdi mdi-marker-check"></i><span class="hide-menu">Commandes</span></a>
                        </li>
                    </ul>
                    <div class="text-center m-t-30">
                        <a href="" class="btn waves-effect waves-light btn-warning hidden-md-down">Download Now</a>
                    </div>
                </nav>
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer"> Copyright © {{ date('Y') }} Créé par <a
                    href=""><strong>Innov</strong></a> </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
